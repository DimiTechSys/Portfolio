...
| Projet | En bref | Stack principale | Démo | Code |
|---|---|---|---|---|
| **PharmaWorkspace** | SaaS B2B pour officines : tâches, OCR d'ordonnances par IA, ruptures de stock, commandes fournisseurs — multi-tenant | Next.js 16 · Supabase · Stripe · Mistral OCR | [🔗 Live](https://www.pharmaworkspace.fr/) | [`/pharmaworkspace`](./pharmaworkspace) |
...
| **MBCZ Drive** | Vitrine + prise de contact pour un service de chauffeur privé Mercedes | React · Vite · Drizzle · Neon | [🔗 Live](https://mbczdrive.com/) | [`/mbczdrive`](./mbczdrive) |
...
| **Occitanie Verte** | Site vitrine pour un paysagiste — statique, optimisé SEO | HTML · CSS · JS | [🔗 Live](https://www.occitanieverte.com/) | [`/occitanie-verte`](./occitanie-verte) |
...
> 💡 *Les autres projets seront ajoutés ici dès qu'ils seront déployés.*
...
🔗 **En ligne :** [pharmaworkspace.fr](https://www.pharmaworkspace.fr/)
...
🔗 **En ligne :** [mbczdrive.com](https://mbczdrive.com/)
...
optimisé SEO.
🔗 **En ligne :** [occitanieverte.com](https://www.occitanieverte.com/)
